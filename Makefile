...
PROC_PROBE_FINAL_BIN = $(BIN_FOLDER)/mprobe
PROC_PROBE_DIR = tools/mprobe
PROC_PROBE_MANIFEST = $(PROC_PROBE_DIR)/Cargo.toml
PROC_PROBE_INTERMEDIATE_BIN = $(abspath $(PROC_PROBE_DIR)/$(RUST_BUILD_PATH)/mprobe)
PROC_PROBE_DEPS = $(PROC_PROBE_DIR)/$(RUST_BUILD_PATH)/mprobe.d

TOOLS += $(PROC_PROBE_FINAL_BIN)
DEPS += $(PROC_PROBE_DEPS)

PROCESS_SAMPLES_FINAL_BIN = $(BIN_FOLDER)/mplot
PROCESS_SAMPLES_DIR = tools/mplot
PROCESS_SAMPLES_MANIFEST = $(PROCESS_SAMPLES_DIR)/Cargo.toml
PROCESS_SAMPLES_INTERMEDIATE_BIN = $(abspath $(PROCESS_SAMPLES_DIR)/$(RUST_BUILD_PATH)/mplot)
PROCESS_SAMPLES_DEPS = $(PROCESS_SAMPLES_DIR)/$(RUST_BUILD_PATH)/mplot.d
